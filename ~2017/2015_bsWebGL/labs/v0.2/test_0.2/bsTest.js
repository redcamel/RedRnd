var bsTest = (function(){
	...
	js = (function(doc){
		...
		return function( id, title, fail ){
			...
			t0.src = 'http://www.bsplugin.com/test_0.2/index.php?f=' + encodeURIComponent(location.href) + '&id=' + encodeURIComponent(title) + '&r=' + (fail ? 0 : 1) + '&rand='+Math.random();
		};
	})(document),
