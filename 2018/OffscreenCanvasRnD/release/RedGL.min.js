...
*/},(RedParticleBitmapMaterial=function(i,n){if(!(this instanceof RedParticleBitmapMaterial))return new RedParticleBitmapMaterial(i,n);i instanceof RedGL||RedGLUtil.throwFunc("RedParticleBitmapMaterial : RedGL Instance만 허용.",i),this.makeProgramList(this,i,"particleBitmapProgram",e,t),this.diffuseTexture=n,this.alpha=1,this.cutOff=.01,this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBaseMaterial,RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","diffuseTexture","sampler2D",{essential:!0}),RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","alpha","number",{min:0,max:1}),RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","cutOff","number",{min:0,max:1}),Object.freeze(RedParticleBitmapMaterial)}(),function(){var e,t,r;e=function(){
/* @preserve
varying vec4 vColor;
void main(void) {
vColor = aVertexColor;
...
*/},(RedPointBitmapMaterial=function(i,n){if(!(this instanceof RedPointBitmapMaterial))return new RedPointBitmapMaterial(i,n);i instanceof RedGL||RedGLUtil.throwFunc("RedPointBitmapMaterial : RedGL Instance만 허용.",i),this.makeProgramList(this,i,"pointBitmapProgram",e,t),this.diffuseTexture=n,this.alpha=1,this.cutOff=.1,this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBaseMaterial,RedDefinePropertyInfo.definePrototype("RedPointBitmapMaterial","alpha","number",{min:0,max:1}),RedDefinePropertyInfo.definePrototype("RedPointBitmapMaterial","cutOff","number",{min:0,max:1}),RedDefinePropertyInfo.definePrototype("RedPointBitmapMaterial","diffuseTexture","sampler2D",{essential:!0}),Object.freeze(RedPointBitmapMaterial)}(),function(){var e,t,r;e=function(){
/* @preserve
// 스키닝
//#REDGL_DEFINE#vertexShareFunc#getSkinMatrix#
// Sprite3D
