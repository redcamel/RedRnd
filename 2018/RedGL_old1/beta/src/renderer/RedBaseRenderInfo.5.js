...
(function () {
    ...
    RedBaseRenderInfo = function (redGL, redScene, callback) {
        ...
        var useMap,useMap2,useMap3, tUseMapKey, tUseMapTextureKey
        ...
        this.draw = function (renderList, time, parentMTX) {
            ...
            while (i--) {
                ...
                useMap3 = {
                    uNormalTexture : 0,
                    uDisplacementTexture : 0,
                    uSpecularTexture : 0,
                    uEtcVertextTexture1 : 0,
                    uEtcVertextTexture2 : 0,
                    uEtcFragmentTexture1 : 0,
                    uEtcFragmentTexture2 : 0,
                    uReflectionTexture : 0,
                    uRefractionTexture :0
                }
                while (i2--) {
                        ...
                        if (tUniformValue && tUniformValue['__webglTextureYn']) {
                            ...
                            if (tUniformValue['loaded']) {
                                ...
                                if (useMap2[tUniformKey]) {
                                    tUseMapKey = useMap2[tUniformKey][0]
                                    var tUseUniformValue = tProgramInfo['uniforms'][tUseMapKey]                    
                                    cacheUseTexture[tUseMapKey] == 0 ? 0 : tGL.uniform1i(tUseUniformValue['location'], 0), cacheUseTexture[tUseMapKey] = 0
                                }
                                bitmapRenderable = false
                            }
                        }
