    ...
    RedBaseRenderInfo = function (redGL, redScene, callback) {
        ...
        this.draw = function (renderList, time, parentMTX) {
            ...
            while (i--) {
                ...
                // aCz = COS(tRz),
                tRadian = tRx,
                tRadian = tRadian % 6.283185307179586,
                tRadian < -3.141592653589793 ? tRadian += 6.283185307179586 : tRadian > 3.141592653589793 ? tRadian -= 6.283185307179586 : 0,
                tRadian = tRadian < 0 ? 1.27323954 * tRadian + 0.405284735 * tRadian * tRadian : (1.27323954 * tRadian - 0.405284735 * tRadian * tRadian),
                aSx = tRadian < 0 ? .225 * (tRadian *-tRadian - tRadian) + tRadian : (.225 * (tRadian * tRadian - tRadian) + tRadian),

                tRadian = tRx,
                tRadian+=  1.5707963267948966,
                tRadian = tRadian % 6.283185307179586,
                tRadian < -3.141592653589793 ? tRadian += 6.283185307179586 : tRadian > 3.141592653589793 ? tRadian -= 6.283185307179586 : 0,
                tRadian = tRadian < 0 ? 1.27323954 * tRadian + 0.405284735 * tRadian * tRadian : (1.27323954 * tRadian - 0.405284735 * tRadian * tRadian),
                aCx = tRadian < 0 ? .225 * (tRadian *-tRadian - tRadian) + tRadian : (.225 * (tRadian * tRadian - tRadian) + tRadian),
             
                tRadian = tRy,
                tRadian = tRadian % 6.283185307179586,
                tRadian < -3.141592653589793 ? tRadian += 6.283185307179586 : tRadian > 3.141592653589793 ? tRadian -= 6.283185307179586 : 0,
                tRadian = tRadian < 0 ? 1.27323954 * tRadian + 0.405284735 * tRadian * tRadian : (1.27323954 * tRadian - 0.405284735 * tRadian * tRadian),
                aSy = tRadian < 0 ? .225 * (tRadian *-tRadian - tRadian) + tRadian : (.225 * (tRadian * tRadian - tRadian) + tRadian),
                ...
                tRadian < -3.141592653589793 ? tRadian += 6.283185307179586 : tRadian > 3.141592653589793 ? tRadian -= 6.283185307179586 : 0,
                tRadian = tRadian < 0 ? 1.27323954 * tRadian + 0.405284735 * tRadian * tRadian : (1.27323954 * tRadian - 0.405284735 * tRadian * tRadian),
                aCy = tRadian < 0 ? .225 * (tRadian *-tRadian - tRadian) + tRadian : (.225 * (tRadian * tRadian - tRadian) + tRadian),
             
                tRadian = tRz,
                tRadian = tRadian % 6.283185307179586,
                tRadian < -3.141592653589793 ? tRadian += 6.283185307179586 : tRadian > 3.141592653589793 ? tRadian -= 6.283185307179586 : 0,
                tRadian = tRadian < 0 ? 1.27323954 * tRadian + 0.405284735 * tRadian * tRadian : (1.27323954 * tRadian - 0.405284735 * tRadian * tRadian),
                aSz = tRadian < 0 ? .225 * (tRadian *-tRadian - tRadian) + tRadian : (.225 * (tRadian * tRadian - tRadian) + tRadian),
                ...
                tRadian < -3.141592653589793 ? tRadian += 6.283185307179586 : tRadian > 3.141592653589793 ? tRadian -= 6.283185307179586 : 0,
                tRadian = tRadian < 0 ? 1.27323954 * tRadian + 0.405284735 * tRadian * tRadian : (1.27323954 * tRadian - 0.405284735 * tRadian * tRadian),
                aCz = tRadian < 0 ? .225 * (tRadian *-tRadian - tRadian) + tRadian : (.225 * (tRadian * tRadian - tRadian) + tRadian),
                /////////////////////////
