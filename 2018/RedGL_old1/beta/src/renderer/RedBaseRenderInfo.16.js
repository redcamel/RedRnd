        ...
        this.draw = function (renderList, time, parentMTX) {
            ...
            while (i--) {
                ...
                while (i2--) {
                    ...
                    else if (tRenderType == INT) tCacheIntFloat[tLocationUUID] == tUniformValue ? 0 : targetGL.uniform1i(tLocation, tCacheIntFloat[tLocationUUID] = tUniformValue)
                    else if (tRenderType == FLOAT) tCacheIntFloat[tLocationUUID] == tUniformValue ? 0 : targetGL.uniform1f(tLocation, tCacheIntFloat[tLocationUUID] = tUniformValue)
                    ...
                    // 아틀라스코디네이트값인경우
                    else if (tRenderType == ATLASCOORD) tCacheUVAtlascoord[tLocationUUID] == tUniformValue['__UUID'] ? 0 : targetGL.uniform4fv(tLocation, tUniformValue['value']), tCacheUVAtlascoord[tLocationUUID] = tUniformValue['__UUID']
                    // 이도저도아닌경우는 뭔가 잘못된거임
